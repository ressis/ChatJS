...
// keys are keys to sub event maps, and the empty
...
var integrate = function() {
	var helper = function(op) {
		return function() {
			var args = utility.make_array(arguments)
			args.unshift(this) // "this" is the object we refer to
			op.apply(this,args)
		}
	}

	Object.prototype.subscribe = helper(subscribe)
	Object.prototype.unsubscribe = helper(unsubscribe)
	Object.prototype.trigger = helper(trigger)
}
